...
namespace _240918CalcTrainer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("So far " + versuche + " tries, " + korrekt + " correct " + falsch + "false \nPlay again?");
            string playagain=Console.ReadLine();
            if (playagain==("y"))
            {
                operatorwahl = rnd.Next(0, 4);
                zahl1 = rnd.Next(1, 101);
                zahl2 = rnd.Next(1, 101);
                eingabetext = Console.ReadLine();
                eingabedo = (Convert.ToDouble(eingabetext));
